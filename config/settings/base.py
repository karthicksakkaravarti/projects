...
ACCOUNT_FORMS = {"signup": "projects.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "projects.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "projects.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "projectsAI API",
    "DESCRIPTION": "Documentation of API endpoints of projects",
    "VERSION": "1.0.0",
...
GITEA = {
    ...
    'TOKEN': env("GITEA_TOKEN"),  # Replace with your actual token
}